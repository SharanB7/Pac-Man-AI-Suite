...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        # Initializing a counter to store Q-Values
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Returning Q-Value for selected state and action
    ...
    def computeValueFromQValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Finding value for a given state and action
        qValues = []
        for action in self.getLegalActions(state):
            qValues.append(self.getQValue(state, action))
        # Returning 0.0 for terminal state
        return max(qValues) if self.getLegalActions(state) else 0.0
    ...
    def computeActionFromQValues(self, state):
        ...
        "*** YOUR CODE HERE ***"
        bestActions = []
        # Finding the actions that have maximum Q-Value
        for action in self.getLegalActions(state):
            if self.getQValue(state, action) == self.computeValueFromQValues(state):
                bestActions.append(action)
        # Returning an action at random if there are multiple actions with maximum Q-Value
    ...
    def getAction(self, state):
        ...
        action = None
        "*** YOUR CODE HERE ***"
        # Choosing a random action with epsilon probability and the best action with (1 - epsilon) probability
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Updating Q-Value without any transition probabilities
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Returning the dot product of weights and features
